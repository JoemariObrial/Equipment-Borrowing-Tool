...
const displayRecords = (rscustomer) => {
  ...
  var html = `
        <table id="customerTable" class="min-w-full bg-white shadow-md rounded-lg overflow-hidden mt-2">
            <thead>
  ...
  rscustomer.forEach((Customer) => {
    html += `
            <tr>
                ...
                <td class="text-left px-6 text-center">
                <button onclick="EditCus(${Customer.customer_id})" class="bg-blue-500 text-white rounded h-10 w-20">Edit</button>

                <button class="bg-red-600 text-white rounded h-10 w-20">Delete</button>
            </tr>`;
  });
